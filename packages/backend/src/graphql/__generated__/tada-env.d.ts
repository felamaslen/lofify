...
export type introspection_types = {
    ...
    'Quality': { name: 'Quality'; enumValues: 'HIGH' | 'LOW' | 'MEDIUM'; };
    ...
    'String': unknown;
    'Subscription': { kind: 'OBJECT'; name: 'Subscription'; fields: { 'libraryScan': { name: 'libraryScan'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'LibraryScan'; ofType: null; }; } }; 'transcodeProgress': { name: 'transcodeProgress'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TranscodeProgress'; ofType: null; }; } }; }; };
    ...
    'TranscodeProgress': { kind: 'OBJECT'; name: 'TranscodeProgress'; fields: { 'chunkDurationSeconds': { name: 'chunkDurationSeconds'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; 'isDone': { name: 'isDone'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; }; } }; 'readyChunks': { name: 'readyChunks'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; }; };
