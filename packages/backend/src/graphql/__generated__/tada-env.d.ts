...
export type introspection_types = {
    ...
    'String': unknown;
    'Subscription': { kind: 'OBJECT'; name: 'Subscription'; fields: { 'libraryScan': { name: 'libraryScan'; type: { kind: 'OBJECT'; name: 'LibraryScan'; ofType: null; } }; 'transcodeProgress': { name: 'transcodeProgress'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TranscodeProgress'; ofType: null; }; } }; }; };
