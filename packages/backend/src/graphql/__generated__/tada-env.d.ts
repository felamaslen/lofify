...
export type introspection_types = {
    ...
    'TranscodeProgress': { kind: 'OBJECT'; name: 'TranscodeProgress'; fields: { 'bytesTranscoded': { name: 'bytesTranscoded'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; 'isDone': { name: 'isDone'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; }; } }; 'secondsTranscoded': { name: 'secondsTranscoded'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Float'; ofType: null; }; } }; }; };
