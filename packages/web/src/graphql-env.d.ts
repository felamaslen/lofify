...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'LibraryScan': { kind: 'OBJECT'; name: 'LibraryScan'; fields: { 'errorsTotal': { name: 'errorsTotal'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; 'filesTotal': { name: 'filesTotal'; type: { kind: 'SCALAR'; name: 'Int'; ofType: null; } }; 'id': { name: 'id'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'ID'; ofType: null; }; } }; 'scannedTotal': { name: 'scannedTotal'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; }; };
    'Mutation': { kind: 'OBJECT'; name: 'Mutation'; fields: { 'libraryScan': { name: 'libraryScan'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'LibraryScan'; ofType: null; }; } }; 'noop': { name: 'noop'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Void'; ofType: null; }; } }; }; };
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'ping': { name: 'ping'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; 'track': { name: 'track'; type: { kind: 'OBJECT'; name: 'Track'; ofType: null; } }; 'tracks': { name: 'tracks'; type: { kind: 'OBJECT'; name: 'TrackConnection'; ofType: null; } }; }; };
    'String': unknown;
